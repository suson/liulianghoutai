    ...
    <table border="0" cellpadding="0" cellspacing="0" style="margin-left:15px;width: 200px; height: 79px">
        ...
        <tr>
            <td style="width: 200px; height: 25px">
                &nbsp;级别：<span id="Span_User_Level"></span></td>
        </tr>
        <tr>
            <td style="width: 200px; height: 25px">
            </td>
        ...
        <tr>
            <td style="width: 200px; height: 24px">
            &nbsp;<img src="images/nav_icon.gif" width="4" height="7" alt="" /><A href="index.html" target="_blank">龙卷风在线服务中心</a></td>
        </tr>
    </table>
    </td>
